...
await db.insert(schema.IgboDictionary).values([
                ...
                { id: 24, word: "underneath", both: "Okpuru: underneath", meaning: "okpuru", synonyms: null, homonyms: null, audio: "okpu.mp3" },
                ...
                { id: 43, word: "early", both: "Maa uzo: early", meaning: "maa uzo", synonyms: null, homonyms: null, audio: "maau.mp3" },
                ...
                { id: 46, word: "evil", both: "Ajo, Ihe ojoo: evil", meaning: "ajo, ihe ojoo", synonyms: null, homonyms: null, audio: "ajoi.mp3" },
                { id: 47, word: "exceed", both: "Karia: exceed", meaning: "karia", synonyms: null, homonyms: null, audio: "kari.mp3" },
                { id: 48, word: "except for", both: "Ewezuga: except", meaning: "ewezuga", synonyms: null, homonyms: null, audio: "ewez.mp3" },
...
await db.insert(schema.HausaDictionary).values([
        ...
        { id: 9, word: "heroine", both: "Holder lbilis: heroin", meaning: "holder lbilis", audio: "hold.mp3" },
        ...
        { id: 16, word: "wash clothes", both: "Wake kaya: wash cloth", meaning: "wake kaya", audio: "wake.mp3" },
        { id: 17, word: "wake up", both: "Farka: wake up", meaning: "fark", audio: "fark.mp3" },
...
await db.insert(schema.YorubaDictionary).values([
        ...
        { id: 24, word: "underneath", both: "Ní isalẹ: underneath", meaning: "ní isalẹ", audio: "niis.mp3" },
