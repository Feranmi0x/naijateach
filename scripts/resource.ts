...
await db.insert(schema.body).values([
        ...
        { id: 15, english: "Jaw", hausa: "Kashi haɓa", audioPath: "kas.mp3" },  
        ...
        { id: 21, english: "Spine", hausa: "Kashin baya", audioPath: "kas2.mp3" },  
        ...
        { id: 35, english: "Knees", hausa: "Gwiwowi", audioPath: "gui.mp3" },  
        ...
        { id: 47, english: "Joints", hausa: "Mahadin gwiwowi", audioPath: "san.mp3" },  
...
await db.insert(schema.igrelatives).values([
        ...
        { id: 17, english: "Uncle", igbo: "Nwanne nwoke nne na nna", audioPath: "nwa10.mp3" },  
        { id: 18, english: "Aunt", igbo: "Nwanne nwaanyi nne na nna", audioPath: "nwa11.mp3" },  
