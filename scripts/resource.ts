...
await db.insert(schema.igbody).values([
                ...
                { id: 41, english: "Heart", igbo: "Mkpụrụ obi", audioPath: "hear.mp3" },
                { id: 42, english: "Stomach", igbo: "Afọ", audioPath: "afo.mp3" },
                { id: 43, english: "Skin", igbo: "Anụ ahụ", audioPath: "anu.mp3" },
                { id: 44, english: "Bones", igbo: "Ọkpụkpụ", audioPath: "bone.mp3" },
...
await db.insert(schema.igrelatives).values([
        ...
        { id: 9, english: "First son", igbo: "Ọkpara", audioPath: "firs.mp3" },  
        ...
        { id: 19, english: "Niece", igbo: "Nwa nwaanyi nwanne nne na nna", audioPath: "nwa12.mp3" },  
        { id: 20, english: "Nephew", igbo: "Nwa nwoke nwanne nne na nna", audioPath: "nwa13.mp3" },  
...
await db.insert(schema.yrrelatives).values([
        ...
        { id: 5, english: "Son", yoruba: "Ọmọ ọkùnrin", audioPath: "omoN2.mp3" },  
        { id: 6, english: "Daughter", yoruba: "Ọmọ obìnrin", audioPath: "omoN1.mp3" },  
        { id: 7, english: "First daughter", yoruba: "Àkọ́bí obìnrin", audioPath: "firsd.mp3" },  
